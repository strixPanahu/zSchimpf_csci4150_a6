...
chromatic_values = (vertical_shift * (vertical_shift - 1) * (vertical_shift - 2)**2)

pyplot.figure(figsize=(10, 6))

pyplot.title("Chromatic Polynomial: $k(k-1)(k-2)^2$")
pyplot.xlabel("k (Number of Colors)")
pyplot.ylabel("Chromatic Polynomial Value")

pyplot.plot(vertical_shift, chromatic_values, label=r"$k(k-1)(k-2)^2$")
